...
TJ_CF_ADC_SAR12_sar_refs_core } { ;# Load abstract cells
	if { [file exists /tmp/tmpit974p1_/repo/precheck_results/20_SEP_2026___06_41_40/tmp/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmpit974p1_/repo/precheck_results/20_SEP_2026___06_41_40/tmp/ext/$cell.lef
	}
}
...
puts "\nExtracting /tmp/tmpit974p1_/repo/gds/user_project_wrapper.gds"
gds read /tmp/tmpit974p1_/repo/gds/user_project_wrapper.gds
cd /tmp/tmpit974p1_/repo/precheck_results/20_SEP_2026___06_41_40/tmp/ext
