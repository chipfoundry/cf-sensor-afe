...
sky130_fd_sc_hd__tapvpwrvgnd_1$1 } { ;# Load abstract cells
	if { [file exists /tmp/tmpr2wjz_re/repo/precheck_results/17_SEP_2026___20_12_29/tmp/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmpr2wjz_re/repo/precheck_results/17_SEP_2026___20_12_29/tmp/ext/$cell.lef
	}
}
...
puts "\nExtracting /tmp/tmpr2wjz_re/repo/gds/user_project_wrapper.gds"
gds read /tmp/tmpr2wjz_re/repo/gds/user_project_wrapper.gds
cd /tmp/tmpr2wjz_re/repo/precheck_results/17_SEP_2026___20_12_29/tmp/ext
