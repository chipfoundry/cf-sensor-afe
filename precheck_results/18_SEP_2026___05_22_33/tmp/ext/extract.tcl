...
sky130_fd_sc_hd__tapvpwrvgnd_1$1 } { ;# Load abstract cells
	if { [file exists /tmp/tmpt_egflp6/repo/precheck_results/18_SEP_2026___05_22_33/tmp/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmpt_egflp6/repo/precheck_results/18_SEP_2026___05_22_33/tmp/ext/$cell.lef
	}
}
...
puts "\nExtracting /tmp/tmpt_egflp6/repo/gds/user_project_wrapper.gds"
gds read /tmp/tmpt_egflp6/repo/gds/user_project_wrapper.gds
cd /tmp/tmpt_egflp6/repo/precheck_results/18_SEP_2026___05_22_33/tmp/ext
