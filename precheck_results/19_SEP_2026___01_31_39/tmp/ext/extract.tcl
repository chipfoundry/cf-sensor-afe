...
foreach cell { CF_ADC_SAR12_core
CF_ADC_SAR12_sar_refs_core
CF_BGR_core
CF_BUF_HIZ_core
CF_REFBUF_core
sky130_fd_sc_hd__fill_1$1
sky130_fd_sc_hd__fill_2$1
sky130_fd_sc_hd__fill_4$1
sky130_fd_sc_hd__fill_8$1
sky130_fd_sc_hd__tapvpwrvgnd_1$1 } { ;# Load abstract cells
	if { [file exists /tmp/tmp3nr2oo_5/repo/precheck_results/19_SEP_2026___01_31_39/tmp/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmp3nr2oo_5/repo/precheck_results/19_SEP_2026___01_31_39/tmp/ext/$cell.lef
	}
}
...
puts "\nExtracting /tmp/tmp3nr2oo_5/repo/gds/user_project_wrapper.gds"
gds read /tmp/tmp3nr2oo_5/repo/gds/user_project_wrapper.gds
cd /tmp/tmp3nr2oo_5/repo/precheck_results/19_SEP_2026___01_31_39/tmp/ext
...
sky130_fd_sc_hd__fill_4$1
sky130_fd_sc_hd__fill_8$1
sky130_fd_sc_hd__tapvpwrvgnd_1$1 } { ;# Set abstract cells
	load $cell
