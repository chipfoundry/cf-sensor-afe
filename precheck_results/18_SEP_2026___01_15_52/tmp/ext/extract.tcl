...
sky130_fd_sc_hd__tapvpwrvgnd_1$1 } { ;# Load abstract cells
	if { [file exists /tmp/tmp7e_14m3k/repo/precheck_results/18_SEP_2026___01_15_52/tmp/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmp7e_14m3k/repo/precheck_results/18_SEP_2026___01_15_52/tmp/ext/$cell.lef
	}
}
...
puts "\nExtracting /tmp/tmp7e_14m3k/repo/gds/user_project_wrapper.gds"
gds read /tmp/tmp7e_14m3k/repo/gds/user_project_wrapper.gds
cd /tmp/tmp7e_14m3k/repo/precheck_results/18_SEP_2026___01_15_52/tmp/ext
