...
sky130_fd_sc_hd__tapvpwrvgnd_1$1 } { ;# Load abstract cells
	if { [file exists /tmp/tmpzfkqgsce/repo/precheck_results/18_SEP_2026___15_47_41/tmp/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmpzfkqgsce/repo/precheck_results/18_SEP_2026___15_47_41/tmp/ext/$cell.lef
	}
}
...
puts "\nExtracting /tmp/tmpzfkqgsce/repo/gds/user_project_wrapper.gds"
gds read /tmp/tmpzfkqgsce/repo/gds/user_project_wrapper.gds
cd /tmp/tmpzfkqgsce/repo/precheck_results/18_SEP_2026___15_47_41/tmp/ext
