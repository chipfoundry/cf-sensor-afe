...
sky130_fd_sc_hd__tapvpwrvgnd_1$1 } { ;# Load abstract cells
	if { [file exists /tmp/tmpucwkft_g/repo/precheck_results/19_SEP_2026___03_36_26/tmp/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmpucwkft_g/repo/precheck_results/19_SEP_2026___03_36_26/tmp/ext/$cell.lef
	}
}
...
puts "\nExtracting /tmp/tmpucwkft_g/repo/gds/user_project_wrapper.gds"
gds read /tmp/tmpucwkft_g/repo/gds/user_project_wrapper.gds
cd /tmp/tmpucwkft_g/repo/precheck_results/19_SEP_2026___03_36_26/tmp/ext
