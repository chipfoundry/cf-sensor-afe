...
puts "Abstracting /tmp/tmp_k97ni63/repo/gds/user_project_wrapper.gds"
...
T2_CF_BUF_HIZ_core
TJ_CF_ADC_SAR12_sar_refs_core } { ;# Set abstract cells and delete all their subcell instances.
	load $cell
