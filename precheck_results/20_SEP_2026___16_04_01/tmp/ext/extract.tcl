...
foreach cell { BI_CF_BGR_core
C0_CF_REFBUF_core
KX_CF_ADC_SAR12_core
SS_sky130_fd_sc_hd__fill_1
SS_sky130_fd_sc_hd__fill_2
SS_sky130_fd_sc_hd__fill_4
SS_sky130_fd_sc_hd__fill_8
SS_sky130_fd_sc_hd__tapvpwrvgnd_1
T2_CF_BUF_HIZ_core
TJ_CF_ADC_SAR12_sar_refs_core } { ;# Load abstract cells
	if { [file exists /tmp/tmp_k97ni63/repo/precheck_results/20_SEP_2026___16_04_01/tmp/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmp_k97ni63/repo/precheck_results/20_SEP_2026___16_04_01/tmp/ext/$cell.lef
	}
}
...
puts "\nExtracting /tmp/tmp_k97ni63/repo/gds/user_project_wrapper.gds"
gds read /tmp/tmp_k97ni63/repo/gds/user_project_wrapper.gds
cd /tmp/tmp_k97ni63/repo/precheck_results/20_SEP_2026___16_04_01/tmp/ext
...
SS_sky130_fd_sc_hd__tapvpwrvgnd_1
T2_CF_BUF_HIZ_core
TJ_CF_ADC_SAR12_sar_refs_core } { ;# Set abstract cells
	load $cell
