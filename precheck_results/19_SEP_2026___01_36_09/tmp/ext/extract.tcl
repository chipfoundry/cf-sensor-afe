...
sky130_fd_sc_hd__tapvpwrvgnd_1$1 } { ;# Load abstract cells
	if { [file exists /tmp/tmpt55hhcez/repo/precheck_results/19_SEP_2026___01_36_09/tmp/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmpt55hhcez/repo/precheck_results/19_SEP_2026___01_36_09/tmp/ext/$cell.lef
	}
}
...
puts "\nExtracting /tmp/tmpt55hhcez/repo/gds/user_project_wrapper.gds"
gds read /tmp/tmpt55hhcez/repo/gds/user_project_wrapper.gds
cd /tmp/tmpt55hhcez/repo/precheck_results/19_SEP_2026___01_36_09/tmp/ext
