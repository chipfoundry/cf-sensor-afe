...
sky130_fd_sc_hd__tapvpwrvgnd_1$1 } { ;# Load abstract cells
	if { [file exists /tmp/tmph4tj42t2/repo/precheck_results/18_SEP_2026___16_57_22/tmp/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmph4tj42t2/repo/precheck_results/18_SEP_2026___16_57_22/tmp/ext/$cell.lef
	}
}
...
puts "\nExtracting /tmp/tmph4tj42t2/repo/gds/user_project_wrapper.gds"
gds read /tmp/tmph4tj42t2/repo/gds/user_project_wrapper.gds
cd /tmp/tmph4tj42t2/repo/precheck_results/18_SEP_2026___16_57_22/tmp/ext
