...
foreach cell { sky130_fd_sc_hd__fill_1$1
...
sky130_fd_sc_hd__tapvpwrvgnd_1$1 } { ;# Load abstract cells
	if { [file exists /tmp/tmpvjn2kage/repo/precheck_results/16_SEP_2026___21_38_25/tmp/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmpvjn2kage/repo/precheck_results/16_SEP_2026___21_38_25/tmp/ext/$cell.lef
	}
}
...
puts "\nExtracting /tmp/tmpvjn2kage/repo/gds/user_project_wrapper.gds"
gds read /tmp/tmpvjn2kage/repo/gds/user_project_wrapper.gds
cd /tmp/tmpvjn2kage/repo/precheck_results/16_SEP_2026___21_38_25/tmp/ext
